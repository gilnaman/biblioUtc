...
<body style="background: #eaeaea; overflow: hidden;">
    ...
    <div id="auth">
                    ...
                    <div class="card-body p-0 pb-4 p-lg-4">
                        <div class="px-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" :class="{ 'is-invalid': erroresValidacion.matricula != null }"
                                    class="form-control" placeholder="Ingrese su matricula escolar"
                                    v-model="data.matricula">
                            </div>
                            <span class="text-danger text-sm"
                                v-if="erroresValidacion.matricula">@{{ erroresValidacion.matricula }}</span>
                        </div>

                        <button type="button" class="btn btn-primary btn-block float-end mt-4 me-4"
                            @click.prevent="validarMatricula()">Acceder</button>
                    </div>
                </div>
        ...
        <!-- Modal para registrar la accion -->
        <div class="modal fade" id="modalAccion" tabindex="-1" role="dialog" aria-labelledby="Modal_acciones"
            aria-hidden="true">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <select :class="{ 'is-invalid': erroresValidacion.actividad != null }" class="form-control"
                            name="actividad" v-model="data.actividad">

                            <!-- Cargar la vista usando Laravel -->
                            <option value="-1" selected>SELECCIONE UNA OPCIÓN</option>

                            <option v-for="act in actividades" v-bind:value="act.id_actividad"> @{{ act.actividad }}
                            </option>
                        ...
                        <span class="text-danger text-sm"
                            v-if="erroresValidacion.actividad">@{{ erroresValidacion.actividad }}</span>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            @click="resetUI">Cerrar</button>
